...
<%@include file="../common/taglibs.jsp" %>
		...
		<form:form id="save-accountingInfo" method="POST" commandName="account" action="/SMS/account/save2.html">
		...
		<c:if test="${!empty accounts}"> 
						...
						<br>
						<form:label for="student-councilfee" path="studentCouncilFee" >Student Council Fee:</form:label>
						...
						<form:label for="mode-ofPayment" path="modeOfPayment" >Mode of Payment:</form:label>
			      		<form:input path="modeOfPayment" name="modeOfPayment" id="modeOfPayment" placeholder="Full Payment" onblur="return blank(\"modeOfPayment\")"/>
