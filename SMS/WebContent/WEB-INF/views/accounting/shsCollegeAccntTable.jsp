...
<%@include file="../common/taglibs.jsp" %>
		...
		<h2 align="center">SHS and College</h2>
	<%--	<h3 align="center"><a href="/SMS/account/add2.html">Add Table Information</a></h3> --%>
				...
				<table class="table table-hover" align="center" border="1">
					...
					<c:forEach items="${accounts}" var="account">
						...
						<tr class="info">
							...
							<td><c:out value="${account.academicUnits}"/></td>
							...
							<td><c:out value="${account.newspaperFee}"/></td>
							<td><c:out value="${account.registrationFee}"/></td>
							<td><c:out value="${account.studentCouncilFee}"/></td>
							<td><c:out value="${account.systemFee}"/></td>
							<td><c:out value="${account.totalTuitionFee}"/></td>
							<td><c:out value="${account.modeOfPayment}"/></td>
							<td align="center"><a href="edit2.html?id=${account.studentNumber}">Edit</a></td>
						</tr>
					</c:forEach>
				</table>
			</c:if>
