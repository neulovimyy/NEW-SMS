...
<div class="content-wrapper">
	...
	<div class="col-md-12">
		<form:form id="view_students" action="${pageContext.request.contextPath}/curriculum/view" method="post" commandName="studentCommand">
														...
														<div class="input-group">
															<div class="input-group-btn">
																...
																<ul class="dropdown-menu">
																	<li><a href="${pageContext.request.contextPath}/path/view?id=${obj.id}"><i class="filesIcon fa fa-edit icon"></i> Edit</a></li>
