...
<div class="content-wrapper">
	...
	<section class="content">
		...
		<div class="col-md-12">
			<form:form id="view_students" action="${pageContext.request.contextPath}/institute/dashboard/curriculum/view" method="post" commandName="curriculumCommand">
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="row">
									...
									<div class="col-lg-1">
										<a type="button" class="btn btn-primary " href="<c:url value="/institute/dashboard/curriculum/form"/>"><i class="fa fa-plus fa-fw"></i> Create</a>
									</div>
								</div>
							</div>
