...
<div class="content-wrapper">
	<section class="content">
		<form:form id="save-student" method="POST" commandName="command" action="${pageContext.request.contextPath}/student/save">
			<div class="col-md-12">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="form-group col-md-4 col-lg-4 col-sm-12 col-xs-12">
							...
							<form:select path="" items="${genderList}" cssClass="form-control" />
						</div>
